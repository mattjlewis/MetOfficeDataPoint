...
public class OrekitUtil {
	...
	public static TopocentricFrame getEarthTopcentricFrame(ObservationLocation observationLocation)
		...
		return new TopocentricFrame(earth_bs, point, observationLocation.getName());
	}
}
