...
public enum DataPointWeatherType {
	NA("Not available"), _0("Clear night"), _1("Sunny day"), _2("Partly cloudy (night)"), _3("Partly cloudy (day)"),
	_4("Not used"), _5("Mist"), _6("Fog"), _7("Cloudy"), _8("Overcast"), _9("Light rain shower (night)"),
	...
	_27("Heavy snow"), _28("Thunder shower (night)"), _29("Thunder shower (day)"), _30("Thunder");

	private String label;

	DataPointWeatherType(String label) {
		this.label = label;
	}
