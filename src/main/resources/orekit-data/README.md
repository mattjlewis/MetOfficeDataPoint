...
This zip file contains:
  ...
  * IERS Earth orientation parameters from 1973 to early 2021
    with predicted data to late 2021 (both IAU-1980 and IAU-2000),
  * configuration data for ITRF versions used in regular IERS files,
  * UTC-TAI history from 1972 to end of 2021,
  * Marshall Solar Activity Future Estimation from 1999 to March 2021,
